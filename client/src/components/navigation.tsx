...
export default function Navigation() {
  ...
  return (
    <nav className="fixed top-0 w-full bg-white/70 dark:bg-gray-900/70 backdrop-blur-[10px] z-50 border-b border-gray-200/50 dark:border-gray-700/50">
            ...
            <div className="ml-10 flex items-baseline space-x-4">
              {navItems.map((item) => (
                <button
                  ...
                  className="text-gray-700 dark:text-gray-300 hover:text-sky-600 dark:hover:text-sky-400 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 hover:bg-sky-50 dark:hover:bg-sky-900/30"
                >
                  {item.label}
                </button>
              ))}
